(RaiselyComponents, React) => {
	...
	return function BlmEmbed(props) {
		...
		const image = `<img src="https://raisely-images.imgix.net/raisely-crm/uploads/fists-png-f77a8c.png?w=70" style="margin: 0; margin-right: 8px; vertical-align: middle; width: 70px; display: inline-block;" />`;
